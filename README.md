...
2. Seek Apple TV or another video player to the beginning.
3. Press Space when you start the video.
...
The MVP supports SRT and WebVTT only. ASS/SSA styling, OCR, Apple TV state detection, sandboxing, signing, and auto-update are intentionally out of scope for this scaffold.
